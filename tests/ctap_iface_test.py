...
class TestCBORCommand:
    ...
    def _make_get_info_cmd(self, cid):
        """Helper: build a CBORCommand for GET_INFO."""
...
class TestCTAPHIDevice:
    """Test the CTAPHIDevice class that processes HID events"""
...
class TestSegmentedMessages:
    ...
    def test_segmented_cbor_message(self, mock_device):
        ...
        This test verifies that the CTAPHIDevice correctly processes and reassembles
...
class TestAuthenticatorAPI:
    ...
    def mock_environment(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # Patch KeyUtils where ctap_interface resolves it (not the source module)
    ...
    def test_get_pin_cose_key(self, mock_pin_token_setup, key_exchange_cid):
        ...
        with patch('soft_fido2.key_pair.KeyUtils.get_cose_key', return_value={'key': 'value'}):
